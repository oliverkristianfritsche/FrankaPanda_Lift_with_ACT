...
def get_args_parser():
    ...
    parser.add_argument('--num_epochs', action='store', type=int, help='num_epochs', default=0)
    parser.add_argument('--kl_weight', action='store', type=float, help='KL Weight', default=10.0)
